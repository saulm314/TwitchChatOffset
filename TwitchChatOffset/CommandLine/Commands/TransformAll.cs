...
public static class TransformAll
{
    ...
    private static readonly (Option<string>, Option<string>, Option<string>, Option<Format>, Option<AnchorPoint>, Option<long>, Option<long>, Option<double>,
        Option<Shadow>, Option<long>, Option<long>, Option<string>, Option<string>, Option<string>, Option<bool>, Option<long>, Option<long>, Option<long>)
        ...
        YttScaleOption, YttShadowOption, YttWindowOpacityOption, YttBackgroundOpacityOption, YttTextColorOption, YttShadowColorOption, YttBackgroundColorOption,
        QuietOption, StartOption, EndOption, DelayOption);
    ...
    private static (string, string, string, string, Format, AnchorPoint, long, long, double, Shadow, long, long, string, string, string, bool, long, long, long)
        GetData(ParseResult p)
    {
        ...
        return (p.GetValue(a1), p.GetValue(o1), p.GetValue(o2), p.GetValue(o3), p.GetValue(o4), p.GetValue(o5), p.GetValue(o6), p.GetValue(o7), p.GetValue(o8),
            ...
            p.GetValue(o17), p.GetValue(o18))!;
    }

    private static void Execute(ParseResult parseResult)
    {
        var (suffix, inputDir, searchPattern, outputDir, format, yttPosition, yttMaxMessages, yttMaxCharsPerLine, yttScale, yttShadow, yttWindowOpacity,
            yttBackgroundOpacity, yttTextColor, yttShadowColor, yttBackgroundColor, quiet, start, end, delay) = GetData(parseResult);
